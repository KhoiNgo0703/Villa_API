let canvasStarMouse, ctx, w, h, particles = [];
...
function init() {
	canvasStarMouse = document.querySelector("#canvasStarMouse");
...
function resizeReset() {
	w = canvasStarMouse.width = window.innerWidth;
	h = canvasStarMouse.height = window.innerHeight;
}
