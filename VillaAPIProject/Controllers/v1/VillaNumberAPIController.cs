...
namespace VillaAPIProject.Controllers.v1
{
    ...
    public class VillaNumberAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetVillaNumber(int id)
        {
            try
            {
                ...
                //check villaNo input validation
                
                if (await _dbVillaNumber.GetAsync(u => u.VillaNo == id) == null)
                {
                    _response.StatusCode = HttpStatusCode.BadRequest;
                    _response.IsSuccess = false;
                    _response.ErrorMessage.Add("Invalid input VillaNo");
                    return BadRequest(_response);
                }
        ...
        public async Task<ActionResult<APIResponse>> CreateVillaNumber([FromBody] VillaNumberCreateDTO createDTO)
        {
            try
            {
                ...
                {
                    ModelState.AddModelError("ErrorMessage", "Villa Number is existed");
